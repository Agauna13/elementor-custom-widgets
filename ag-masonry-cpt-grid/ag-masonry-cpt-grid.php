...
function ag_masonry_get_taxonomies() {
	...
	$options = array( '' => __( 'None', 'ag-masonry' ) );
...
class AG_Masonry_Grid_Widget extends \Elementor\Widget_Base {
		...
		protected function register_controls() {
			...
			// ... (Due to space we are setting the full styles using Elementor Control Groups)
            ...
            $this->add_responsive_control( 'filter_align', [ 'label' => 'Alignment', 'type' => \Elementor\Controls_Manager::CHOOSE, 'options' => [ 'flex-start' => ['title'=>'Left','icon'=>'eicon-h-align-left'], 'center' => ['title'=>'Center','icon'=>'eicon-h-align-center'], 'flex-end' => ['title'=>'Right','icon'=>'eicon-h-align-right'] ], 'selectors' => [ '{{WRAPPER}} .ag-filter' => 'justify-content: {{VALUE}};' ] ] );
...
// Standalone plugin registration (ignored by manager's auto-loader, useful if activated normally)
add_action( 'elementor/widgets/register', function( $widgets_manager ) {
	$widgets_manager->register( new \AG_Masonry_Grid_Widget() );
} );
